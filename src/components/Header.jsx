    ...
    <>
      ...
      <div className="hidden lg:flex justify-center">
        <div className="bg-white rounded-full px-4 py-1 mt-4 flex items-center gap-4 shadow-md">
          ...
          <NavLink to="/delivery" className={navLinkClass}>Account</NavLink>

          <button onClick={toggleDarkMode} className="px-2 py-4 rounded-full text-black transition hover:text-vilagos">
      ...
      >
        ...
        <nav className={`${darkMode ? "text-white" : "text-black"} flex flex-col items-center gap-6 mt-10 text-lg font-semibold`}>
          ...
          <NavLink to="/delivery" className={`${darkMode ? "text-white" : "text-black"} px-4 py-2 rounded-full text-lg transition font-semibold`} onClick={() => setMenuOpen(false)}>Account</NavLink>
